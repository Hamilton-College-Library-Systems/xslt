...
<xsl:include href="collection-constants/JazzInterviews.xsl"/>
...
-->
            ...
            <xsl:when test="contains(text(), 'u=primary')">
               <xsl:if test="not(contains(text(), 'Ephemera')) and not(contains(text(), 'Finding Aids')) and not(contains(text(), 'Publications')) and not(contains(text(), 'Manuscripts')) and not(contains(text(), 'Visual Materials')) and not(contains(text(), 'Audio-Video Materials'))">
...
-->
 ...
 -->
      ...
      <subject authority="aat">
         ...
         <xsl:for-each select="subjectTopic">
            <xsl:if test="contains(text(), '|a=aat')">
               <!-- create subject topic entries -->
               <xsl:call-template name="subjectTopic"/>
            </xsl:if>
         </xsl:for-each>
...
-->
      ...
      <xsl:if test="physicalLocation or shelfLocator or identifier">
         <location>
            ...
            <xsl:for-each select="identifier">
               ...
               <shelfLocator>
                  <!-- <xsl:value-of select="."/> -->
                  <xsl:value-of select="concat('Original digital object name: ',.)"/>
               </shelfLocator>
            </xsl:for-each>
         </location>
      </xsl:if>
...
-->
      <xsl:choose>
         ...
         <xsl:when test="contains(text(), 'aat')">
            <topic>
               <xsl:choose>
                  <xsl:when test="contains(text(), '|')">
                     <xsl:value-of select="normalize-space(substring-before(text(), '|'))"/>
         ...
         <xsl:choose>
            ...
            <xsl:when test="$r = 'interviewee'">
               ...
               <roleTerm>
                  ...
                  <xsl:text>ive</xsl:text>
               </roleTerm>
            </xsl:when>
            <xsl:when test="$r = 'interviewer'">
               <roleTerm>
                  <xsl:attribute name="type">
                     <xsl:text>text</xsl:text>
                  </xsl:attribute>
